  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center lg:text-left" data-aos="fade-up">
        ...
        <p className="mb-4 text-lg text-gray-300" data-aos="fade-up" data-aos-delay="300">
        ...
        <p className="mb-4 text-lg text-gray-300" data-aos="fade-up" data-aos-delay="400">
        ...
        <p className="text-lg text-gray-300" data-aos="fade-up" data-aos-delay="500">
