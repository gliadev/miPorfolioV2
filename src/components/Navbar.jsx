...
export default function Navbar() {
  ...
  {isOpen && (
    <div className="md:hidden mt-4 space-y-3 text-center text-zinc-900 dark:text-gray-100">
      <Link onClick={closeMenu} to="aboutme" smooth duration={500}
        className="block hover:text-blue-600 transition">
        Sobre mí
      </Link>
      <Link onClick={closeMenu} to="proyectos" smooth duration={500}
        className="block hover:text-blue-600 transition">
        Proyectos
      </Link>
      <Link onClick={closeMenu} to="contacto" smooth duration={500}
        className="block hover:text-blue-600 transition">
        Contacto
      </Link>
